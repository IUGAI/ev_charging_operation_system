...
class TextFieldWidget_CardBank extends StatefulWidget {
  const TextFieldWidget_CardBank({
    Key? key,
...
class _TextFieldWidget_CardState extends State<TextFieldWidget_CardBank> {
  @override
      ...
      child: TextFormField(
        ...
        onChanged: (value) {
          ...
          setState(() {
            ...
            print(value);
            stringprovider.setchangebankcardnumberregist(widget.passwordController.text);
          });
        },
      ),
    );
