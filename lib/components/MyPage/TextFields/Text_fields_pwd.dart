...
class TextFieldPwd extends StatefulWidget {
  const TextFieldPwd({
    Key? key,
...
class _TextFieldWidgetState extends State<TextFieldPwd> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        onChanged: (value) {
          setState(() {
            stringprovider.setpassword(value);
        ...
        style: TextStyle(
            color: Colors.white, fontSize: screenWidth > 900 || screenWidth > 600 ? 24 : 15),
