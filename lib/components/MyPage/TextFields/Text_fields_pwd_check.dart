...
class TextFieldPwd_check extends StatefulWidget {
  const TextFieldPwd_check({
    Key? key,
...
class _TextFieldWidgetState extends State<TextFieldPwd_check> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        onChanged: (value) {
          setState(() {
            stringprovider.setpasswordcheck(value);
