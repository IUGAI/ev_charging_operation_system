...
class TextFieldWidget_Card_input extends StatefulWidget {
  const TextFieldWidget_Card_input({
    Key? key,
...
class _TextFieldWidget_CardState extends State<TextFieldWidget_Card_input> {
  @override
  void initState() {
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        onChanged: (value) {
          ...
          stringprovider.setnewvalueofChargeCardNumber(value);
        },
      ),
    );
  }
