...
class Info_Widget_Input_Card_Number extends StatefulWidget {
  const Info_Widget_Input_Card_Number({ required this.borderSide, required this.title, required this.value,
    Key? key,
  }) : super(key: key);
  ...
  @override
  State<Info_Widget_Input_Card_Number> createState() => _Info_Widget_Input_Card_NumberState();
}

class _Info_Widget_Input_Card_NumberState extends State<Info_Widget_Input_Card_Number> {
